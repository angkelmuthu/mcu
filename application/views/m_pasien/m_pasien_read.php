...
<div class="row">
    <div class="col-xl-12">
	    ...
	    <tr><td>Kdklmn</td><td><?php echo $kdklmn; ?></td></tr>
	    <tr><td>Kdkawin</td><td><?php echo $kdkawin; ?></td></tr>
	    ...
	    <tr><td></td><td><a href="<?php echo site_url('m_pasien') ?>" class="btn btn-primary waves-effect waves-themed">Kembali</a></td></tr>
	</table>
</div>
</div>
