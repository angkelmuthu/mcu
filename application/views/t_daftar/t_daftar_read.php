...
<div class="row">
    <div class="col-xl-12">
	    ...
	    <tr><td>Baru</td><td><?php echo $baru; ?></td></tr>
	    ...
	    <tr><td>Rujukan</td><td><?php echo $rujukan; ?></td></tr>
	    <tr><td>Kdrujuk</td><td><?php echo $kdrujuk; ?></td></tr>
	    <tr><td>Tglreg</td><td><?php echo $tglreg; ?></td></tr>
	    <tr><td>Id Users</td><td><?php echo $id_users; ?></td></tr>
	    <tr><td></td><td><a href="<?php echo site_url('t_daftar') ?>" class="btn btn-primary waves-effect waves-themed">Kembali</a></td></tr>
	</table>
</div>
</div>
