                        ...
                        <form action="<?php echo $action; ?>" method="post">
                            ...
                            <table class='table table-striped'>
                                ...
                                <tr>
                                    ...
                                    <td> <textarea class="form-control" rows="3" name="hasil" id="hasil" placeholder="Hasil"><?php echo $hasil; ?></textarea></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td></td>
                                    <td><input type="hidden" name="nobill" value="<?php echo $nobill; ?>" />
                                        <button type="submit" class="btn btn-warning waves-effect waves-themed"><i class="fal fa-save"></i> <?php echo $button ?></button>
                                        <a href="<?php echo site_url('t_radhasil') ?>" class="btn btn-info waves-effect waves-themed"><i class="fal fa-sign-out"></i> Kembali</a></td>
                                </tr>
                            </table>
                        </form>
                    </div>
